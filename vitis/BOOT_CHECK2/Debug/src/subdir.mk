...
src/%.o: ../src/%.c
	...
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -IC:/temp/BOOT_CHECK/vitis/design_1_wrapper/export/design_1_wrapper/sw/design_1_wrapper/standalone_domain/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
